...
class Tableau1 extends Phaser.Scene{
    ...
    preload(){
        this.load.image('carreimg','assets/carre.png');
        this.load.image('cercleimg','assets/cercle.png');
    ...
    create(){
         ...
         */
        this.haut = this.physics.add.sprite(0, 0, 'carreimg').setOrigin(0, 0);
         ...
         * @type {Phaser.Physics.Arcade.Sprite & {body: Phaser.Physics.Arcade.Body}}
         */
        this.bas = this.physics.add.sprite(0, this.height - 20, 'carreimg').setOrigin(0, 0);
         ...
         * @type {Phaser.Physics.Arcade.Sprite & {body: Phaser.Physics.Arcade.Body}}
         */
        this.gauche = this.physics.add.sprite(50, 200, 'carreimg').setOrigin(0, 0);
         ...
         * @type {Phaser.Physics.Arcade.Sprite & {body: Phaser.Physics.Arcade.Body}}
         */
        this.droite = this.physics.add.sprite(this.width - 50, 200, 'carreimg').setOrigin(0, 0);
